  ...
  const solution = [
    {
      ...
      description:
        "Tailored snack solutions driven by market trends and R&D expertise.",
    },
    {
      img: vector3,
      title: "Quality Assurance",
      description:
        "Strict checks from raw material to final output for consistent excellence.",
    },
    {
      img: vector2,
      title: "Packaging & Delivery",
      description:
        "Flexible, retail-ready packaging lines built for global food markets.",
    },
  ];
    ...
    <Box sx={{ py: { xs: 4, md: 6 }, backgroundColor: "#F4F4F4" }}>
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            A reliable process line is the backbone of success in the snack
            pellet industry. Explore how our solutions cover every stage of
            production.
          </Typography>
        </Box>
        <Box
